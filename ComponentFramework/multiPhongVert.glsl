...
void main() {
	...
	eyeDir = -vertDir;
	lightDir = normalize(lightPos1 - vertPos); /// Create the light direction. I do the math with in class
	lightDir2 = normalize(lightPos2 - vertPos); /// Create the light direction. I do the math with in class 
